...
describe('broccoli-asset-rev', function () {
  it('uses the provided assetMap to replace strings', async function () {
    ...
    const subject = new AssetRewrite(input.path(), {
      assetMap: {
        ...
        'fonts/Fiz/Light/Fiz-Light.eot': 'fonts/Fiz/Light/fingerprinted-Fiz-Light.eot',
        'fonts/Fiz/Light/Fiz-Light.woff': 'fonts/Fiz/Light/fingerprinted-Fiz-Light.woff',
        'fonts/Fiz/Light/Fiz-Light.ttf': 'fonts/Fiz/Light/fingerprinted-Fiz-Light.ttf',
        'fonts/Fiz/Light/Fiz-Light.svg': 'fonts/Fiz/Light/fingerprinted-Fiz-Light.svg',
        'fonts/Fiz/Medium/Fiz-Medium.eot': 'fonts/Fiz/Medium/fingerprinted-Fiz-Medium.eot',
        'fonts/Fiz/Medium/Fiz-Medium.woff': 'fonts/Fiz/Medium/fingerprinted-Fiz-Medium.woff',
        'fonts/Fiz/Medium/Fiz-Medium.ttf': 'fonts/Fiz/Medium/fingerprinted-Fiz-Medium.ttf',
        'fonts/Fiz/Medium/Fiz-Medium.svg': 'fonts/Fiz/Medium/fingerprinted-Fiz-Medium.svg',
      },
    });
  ...
  it('handles JavaScript files in a reasonable amount of time', async function () {
    ...
    const subject = new AssetRewrite(input.path(), {
      assetMap: {
        assetMap: JSON.parse(fs.readFileSync(`${fixturesPath}/js-perf/asset-map.json`)),
        replaceExtensions: ['js'],
      },
    });
    const output = createBuilder(subject);
  ...
  it('can optionally use caching', async function () {
    ...
    await output.build();
    let expectedTestSupportOutput = fs
      .readFileSync(`${fixturesPath}/js-perf/output/test-support.js`)
      .toString();
